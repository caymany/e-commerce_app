...
class DTextTheme {
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    bodyMedium: const TextStyle().copyWith(fontSize: 14.0, fontWeight: FontWeight.w400, color: Colors.grey),
  ...
  static TextTheme darkTextTheme = TextTheme(
    ...
    bodyMedium: const TextStyle().copyWith(fontSize: 14.0, fontWeight: FontWeight.w400, color: DColors.white),
